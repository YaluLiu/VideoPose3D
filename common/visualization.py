...
def loss_visualize():
    ...
    ax_3d.plot(epoch_x, losses_3d_train[3:], '--', color='C0')
    ax_3d.plot(epoch_x, losses_3d_train_eval[3:], color='C0')
    ax_3d.plot(epoch_x, losses_3d_valid[3:], color='C1')
    ax_3d.legend(['3d train', '3d train (eval)', '3d valid (eval)'])
    ax_3d.set_ylabel('MPJPE (m)')
    ax_3d.set_xlabel('Epoch')
    ax_3d.set_xlim((3, epoch))

    ax_traj = fig.add_subplot(1,3,2)
    ax_traj.plot(epoch_x, losses_traj_train[3:], '--', color='C0')
    ax_traj.plot(epoch_x, losses_traj_train_eval[3:], color='C0')
    ax_traj.plot(epoch_x, losses_traj_valid[3:], color='C1')
    ax_traj.legend(['traj. train', 'traj. train (eval)', 'traj. valid (eval)'])
    ax_traj.set_ylabel('Mean distance (m)')
    ax_traj.set_xlabel('Epoch')
    ax_traj.set_xlim((3, epoch))

    ax_2d = fig.add_subplot(1,3,3)
    ax_2d.plot(epoch_x, losses_2d_train_labeled_eval[3:], color='C0')
    ax_2d.plot(epoch_x, losses_2d_train_unlabeled[3:], '--', color='C1')
    ax_2d.plot(epoch_x, losses_2d_train_unlabeled_eval[3:], color='C1')
    ax_2d.plot(epoch_x, losses_2d_valid[3:], color='C2')
